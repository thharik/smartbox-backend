...
const conteudos = [
  ...
  filme({
    ...
    posterArquivo: "sword-art-online.jpg",
  ...
  serie({
    ...
    episodios: [
      ...
      ep("eva", "Neon Genesis Evangelion", 5, "EvanelionEP5.mp4"),
      ep("eva", "Neon Genesis Evangelion", 6, "EvanelionEP6.mp4"),
      ep("eva", "Neon Genesis Evangelion", 7, "EvanelionEP7.mp4"),
      ep("eva", "Neon Genesis Evangelion", 8, "EvanelionEP8.mp4"),
      ep("eva", "Neon Genesis Evangelion", 9, "EvanelionEP9.mp4"),
      ep("eva", "Neon Genesis Evangelion", 10, "EvanelionEP10.mp4"),
      ep("eva", "Neon Genesis Evangelion", 11, "EvanelionEP11.mp4"),
      ep("eva", "Neon Genesis Evangelion", 12, "EvanelionEP12.mp4"),
      ep("eva", "Neon Genesis Evangelion", 13, "EvanelionEP13.mp4"),
      ep("eva", "Neon Genesis Evangelion", 14, "EvanelionEP14.mp4"),
      ep("eva", "Neon Genesis Evangelion", 15, "EvanelionEP15.mp4"),
      ep("eva", "Neon Genesis Evangelion", 16, "EvanelionEP16.mp4"),
      ep("eva", "Neon Genesis Evangelion", 17, "EvanelionEP17.mp4"),
      ep("eva", "Neon Genesis Evangelion", 18, "EvanelionEP18.mp4"),
      ep("eva", "Neon Genesis Evangelion", 19, "EvanelionEP19.mp4"),
      ep("eva", "Neon Genesis Evangelion", 20, "EvanelionEP20.mp4"),
      ep("eva", "Neon Genesis Evangelion", 21, "EvanelionEP21.mp4"),
      ep("eva", "Neon Genesis Evangelion", 22, "EvanelionEP22.mp4"),
      ep("eva", "Neon Genesis Evangelion", 23, "EvanelionEP23.mp4"),
      ep("eva", "Neon Genesis Evangelion", 24, "EvanelionEP24.mp4"),
      ep("eva", "Neon Genesis Evangelion", 25, "EvanelionEP25.mp4"),
      ep("eva", "Neon Genesis Evangelion", 26, "EvanelionEP26.mp4"),
    ],
  }),
  ...
  serie({
    ...
    ano: 2003,
    episodios: [
      ep("gash", "Konjiki no Gash Bell", 1, "Konjiki_no_Gash_BellEP1.mp4"),
      ep("gash", "Konjiki no Gash Bell", 2, "Konjiki_no_Gash_BellEP2.mp4"),
      ep("gash", "Konjiki no Gash Bell", 3, "Konjiki_no_Gash_BellEP3.mp4"),
      ep("gash", "Konjiki no Gash Bell", 4, "Konjiki_no_Gash_BellEP4.mp4"),
      ep("gash", "Konjiki no Gash Bell", 5, "Konjiki_no_Gash_BellEP5.mp4"),
      ep("gash", "Konjiki no Gash Bell", 6, "Konjiki_no_Gash_BellEP6.mp4"),
      ep("gash", "Konjiki no Gash Bell", 7, "GashBellEP7.mp4"),
      ep("gash", "Konjiki no Gash Bell", 8, "GashBellEP8.mp4"),
      ep("gash", "Konjiki no Gash Bell", 9, "GashBellEP9.mp4"),
      ep("gash", "Konjiki no Gash Bell", 10, "KonjikinoGashBellEP10.mp4"),
      ep("gash", "Konjiki no Gash Bell", 11, "KonjikinoGashBellEP11.mp4"),
      ep("gash", "Konjiki no Gash Bell", 12, "KonjikinoGashBellEP12.mp4"),
      ep("gash", "Konjiki no Gash Bell", 13, "KonjikinoGashBellEP13.mp4"),
      ep("gash", "Konjiki no Gash Bell", 14, "KonjikinoGashBellEP14.mp4"),
      ep("gash", "Konjiki no Gash Bell", 15, "KonjikinoGashBellEP15.mp4"),
      ep("gash", "Konjiki no Gash Bell", 16, "KonjikinoGashBellEP16.mp4"),
      ep("gash", "Konjiki no Gash Bell", 17, "KonjikinoGashBellEP17.mp4"),
      ep("gash", "Konjiki no Gash Bell", 18, "KonjikinoGashBellEP18.mp4"),
      ep("gash", "Konjiki no Gash Bell", 19, "KonjikinoGashBellEP19.mp4"),
      ep("gash", "Konjiki no Gash Bell", 20, "KonjikinoGashBellEP20.mp4"),
      ep("gash", "Konjiki no Gash Bell", 21, "KonjikinoGashBellEP21.mp4"),
      ep("gash", "Konjiki no Gash Bell", 22, "KonjikinoGashBellEP22.mp4"),
      ep("gash", "Konjiki no Gash Bell", 23, "KonjikinoGashBellEP23.mp4"),
      ep("gash", "Konjiki no Gash Bell", 24, "KonjikinoGashBellEP24.mp4"),
      ep("gash", "Konjiki no Gash Bell", 25, "KonjikinoGashBellEP25.mp4"),
      ep("gash", "Konjiki no Gash Bell", 26, "KonjikinoGashBellEP26.mp4"),
      ep("gash", "Konjiki no Gash Bell", 27, "KonjikinoGashBellEP27.mp4"),
      ep("gash", "Konjiki no Gash Bell", 28, "KonjikinoGashBellEP28.mp4"),
      ep("gash", "Konjiki no Gash Bell", 29, "KonjikinoGashBellEP29.mp4"),
      ep("gash", "Konjiki no Gash Bell", 30, "KonjikinoGashBellEP30.mp4"),
      ep("gash", "Konjiki no Gash Bell", 31, "KonjikinoGashBellEP31.mp4"),
      ep("gash", "Konjiki no Gash Bell", 32, "KonjikinoGashBellEP32.mp4"),
      ep("gash", "Konjiki no Gash Bell", 33, "KonjikinoGashBellEP33.mp4"),
      ep("gash", "Konjiki no Gash Bell", 34, "KonjikinoGashBellEP34.mp4"),
      ep("gash", "Konjiki no Gash Bell", 35, "KonjikinoGashBellEP35.mp4"),
      ep("gash", "Konjiki no Gash Bell", 36, "KonjikinoGashBellEP36.mp4"),
      ep("gash", "Konjiki no Gash Bell", 37, "KonjikinoGashBellEP37.mp4"),
      ep("gash", "Konjiki no Gash Bell", 38, "KonjikinoGashBell38.mp4"),
      ep("gash", "Konjiki no Gash Bell", 39, "KonjikinoGashBell39.mp4"),
      ep("gash", "Konjiki no Gash Bell", 40, "KonjikinoGashBell40.mp4"),
      ep("gash", "Konjiki no Gash Bell", 41, "KonjikinoGashBell41.mp4"),
      ep("gash", "Konjiki no Gash Bell", 42, "KonjikinoGashBell42.mp4"),
      ep("gash", "Konjiki no Gash Bell", 43, "KonjikinoGashBell43.mp4"),
      ep("gash", "Konjiki no Gash Bell", 44, "KonjikinoGashBell44.mp4"),
      ep("gash", "Konjiki no Gash Bell", 45, "KonjikinoGashBell45.mp4"),
      ep("gash", "Konjiki no Gash Bell", 46, "KonjikinoGashBell46.mp4"),
      ep("gash", "Konjiki no Gash Bell", 47, "KonjikinoGashBell47.mp4"),
    ],
  }),

  serie({
    id: "o-tempo-tras-voce-pra-mim",
    titulo: "O Tempo Traz Você Pra Mim",
    posterArquivo: "OTempoTrásVocêPraMim.jpg",
    descricao:
      "Série dramática com viagem no tempo, romance e mistério envolvendo memórias, perdas e reencontros.",
    generos: ["Drama", "Romance", "Fantasia"],
    classificacao: "12",
    ano: 2023,
    episodios: [
      ep("tempo", "O Tempo Traz Você Pra Mim", 1, "OTempoTrásVocêPraMimEP1.mp4"),
      ep("tempo", "O Tempo Traz Você Pra Mim", 2, "OTempoTrásVocêPraMimEP2.mp4"),
      ep("tempo", "O Tempo Traz Você Pra Mim", 3, "OTempoTrásVocêPraMimEP3.mp4"),
      ep("tempo", "O Tempo Traz Você Pra Mim", 4, "OTempoTrásVocêPraMimEP4.mp4"),
      ep("tempo", "O Tempo Traz Você Pra Mim", 5, "OTempoTrásVocêPraMimEP5.mp4"),
      ep("tempo", "O Tempo Traz Você Pra Mim", 6, "OTempoTrásVocêPraMimEP6.mp4"),
      ep("tempo", "O Tempo Traz Você Pra Mim", 7, "OTempoTrásVocêPraMimEP7.mp4"),
      ep("tempo", "O Tempo Traz Você Pra Mim", 8, "OTempoTrásVocêPraMimEP8.mp4"),
      ep("tempo", "O Tempo Traz Você Pra Mim", 9, "OTempoTrásVocêPraMimEP9.mp4"),
      ep("tempo", "O Tempo Traz Você Pra Mim", 10, "OTempoTrásVocêPraMimEP10.mp4"),
      ep("tempo", "O Tempo Traz Você Pra Mim", 11, "OTempoTrásVocêPraMimEP11.mp4"),
...
const capitulos = [
  {
    ...
    conteudo_id: "gintama",
    numero: 1,
    titulo: "Gintama - Volume 01",
    arquivo: "GINTAMAVOL.01.pdf",
    capa: "gintama.avif",
  },
  {
    id: "jojolion_vol_01",
    ...
    numero: 1,
    titulo: "JojoLion - Volume 01",
    arquivo: "JojoLion1.pdf",
    capa: "jojolion.jpg",
  },
  {
    id: "jojolands_vol_01",
    ...
    numero: 1,
    titulo: "The JoJoLands - Volume 01",
    arquivo: "JOJOLANDSVOL.01.pdf",
    capa: "jojolands.webp",
  },
].map(capituloPDF);
